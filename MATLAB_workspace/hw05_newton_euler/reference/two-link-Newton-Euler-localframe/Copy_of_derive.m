...
f2 = m2*g*(R12'*k) + m2*a_G2;
tau2 = simple(I2*al2 + cross(om2,I2*om2) + cross(r_E_G2,f2));
f1 = m1*g*(R1'*k) + m1*a_G1 + Rxq2*f2;
tau1 = simple(I1*al1 + cross(om1,I1*om1) + cross(r_O_G1,f1) + Rxq2*tau2 - cross(r_O_E-r_O_G1,-Rxq2*f2));
...
PE = m1*g*dot(R1*r_O_G1,k) + m2*g*dot(r_O_G2,k);
