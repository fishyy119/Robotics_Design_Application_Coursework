...
RHS1 = u1*(2*I2_23*u2*cos(2*q2) + I2_2*u2*sin(2*q2) - I2_3*u2*sin(2*q2) + a^2*m2*u2*sin(2*q2)) - T1 + I2_12*u2^2*cos(q2) - I2_13*u2^2*sin(q2) + a*l*m2*u2^2*sin(q2); 
RHS2 = - T2 - u1^2*(I2_23*cos(2*q2) + (I2_2*sin(2*q2))/2 - (I2_3*sin(2*q2))/2 + (a^2*m2*sin(2*q2))/2) - a*g*m2*sin(q2); 
